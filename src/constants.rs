...
// OCR 结果窗口相关常量（简化版本，参考test.rs）
pub const TITLE_BAR_HEIGHT: i32 = 40; // 标题栏高度，参考test.rs
pub const BUTTON_WIDTH_OCR: i32 = 46; // 标题栏按钮宽度，参考test.rs
pub const BUTTON_HEIGHT_OCR: i32 = TITLE_BAR_HEIGHT; // 按钮高度等于标题栏高度
